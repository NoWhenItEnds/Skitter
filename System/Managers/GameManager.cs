...
namespace Skitter.Managers
{
    ...
    public partial class GameManager : SingletonNode<GameManager>
    {
        ...
        /// <summary> An event to signal the moment during a turn to perform a re-render. </summary>
        public EventPublisher TurnRender { get; init; } = new EventPublisher();
        ...
        public EventPublisher TurnAction { get; init; } = new EventPublisher();
        ...
        public void ProgressTurn()
        {
            ...
            Task renderTask = Task.Run(() => TurnRender.InvokeAsync());
            renderTask.GetAwaiter().GetResult();
            Task actionTask = Task.Run(() => TurnAction.InvokeAsync());
