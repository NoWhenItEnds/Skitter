...
using System.Linq;
using Godot;
using Skitter.Entities.Actors.GOAP.Strategies;
...
namespace Skitter.Entities.Actors.GOAP
{
    ...
    public class ActorController
    {
        ...
        public ActorEntity Actor { get; init; }
        ...
        public ActorController(ActorEntity actor)
        {
            Actor = actor;
        ...
        private void InitialiseBasicPackage(FactFactory factFactory)
        {
            ...
            factFactory.AddFact("is_fresh", () => Actor.Stats.StaminaStat.Percent >= 0.9f);
            factFactory.AddFact("is_tired", () => Actor.Stats.StaminaStat.Percent < 0.5f);
            factFactory.AddFact("is_entertained", () => Actor.Stats.EntertainmentStat.Percent >= 0.9f);
            factFactory.AddFact("is_bored", () => Actor.Stats.EntertainmentStat.Percent < 0.5f);
